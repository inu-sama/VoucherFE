...
const GetListVoucher = () => {
  ...
  return (
    <div>
      <header className="w-full grid grid-cols-2 bg-[#fff] h-20">
      ...
      <div className="grid lg:grid-cols-3 gap-6 w-full bg-gradient-to-r from-[#80ed99] to-[#0ad1c8] min-h-screen p-6">
        <div className="lg:col-span-2 bg-[#fff] rounded-xl p-6">
          ...
          <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-6">
            {vouchers.map((voucher) => (
              <div
                key={voucher._id}
                className="w-full bg-gradient-to-r from-[#80ed99] to-[#0ad1c8] rounded-xl p-1 cursor-pointer"
                onClick={() => {
          ...
          <div className="w-full p-1 bg-gradient-to-r from-[#80ed99] to-[#0ad1c8] hover:bg-white mb-4 mt-10 rounded-xl cursor-pointer">
            <div className="bg-white rounded-lg">
              <p
                className="w-full text-center font-bold text-xl hover:bg-gradient-to-r from-[#80ed99] to-[#0ad1c8] text-white hover:bg-clip-text hover:text-transparent p-3 rounded-lg"
                onClick={() => {
        ...
        <div className="col-span-1 bg-[#fff] rounded-xl p-6">
          ...
          <div className="w-full grid grid-cols-2 bg-[#ffffff] [text-shadow:_0_0_1px_#adff2f] p-4 rounded-xl text-lg">
